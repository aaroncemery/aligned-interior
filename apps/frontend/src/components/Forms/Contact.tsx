        ...
        <div className="flex w-full flex-col md:flex-row md:gap-2">
          <div className="relative mb-4 w-full">
            <input
              ...
              required
              className="peer focus:border-brand-interior-green w-full rounded-md border border-gray-300 px-4 py-2 pt-4 font-sans placeholder-transparent focus:outline-none"
              placeholder="Name"
            />
            <label
              htmlFor="name"
